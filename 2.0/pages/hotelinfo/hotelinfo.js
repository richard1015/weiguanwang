...
Page({
  ...
  onShareAppMessage: function() {
    ...
    return {
      ...
      path: '/pages/hotelinfo/hotelinfo?share=1&id=' + that.data.pageData.Id,
  ...
  getPageData: function(id) {
    var that = this;
    apiHelper.paramData.cmd = "FrH5HotelList"; //cmd
  ...
  increaseBrowseVolume: function() {
    var that = this;
    apiHelper.paramData.cmd = "FrHotelByBrowseVolume"; //cmd
    apiHelper.paramData.function = "FrIntegratedH5"; //language
    apiHelper.paramData.param = {
  ...
  getLikes: function() {
    ...
    var that = this;
    apiHelper.paramData.cmd = "FrHotelByFabulous"; //cmd
    apiHelper.paramData.function = "FrIntegratedH5"; //language
    apiHelper.paramData.param = {
      "ID": this.data.pageData.Id
    };
  ...
  initNew: function(share) {
    ...
    if (share==1) {
      ...
      this.setData({
        ...
        pageData: app.globalData.currentHotel
      });
